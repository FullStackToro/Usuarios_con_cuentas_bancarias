...
if __name__ == '__main__':
    ...
    u2 = Usuario('usuario01', 'usuario01@gmail.com')
    ...
    u1.make_deposit(1000, b11).make_withdrawal(100, b11).display_user_balance(b11)
    u1.make_deposit(2000, b12).make_withdrawal(100, b12).display_user_balance(b12)
